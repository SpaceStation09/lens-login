  ...
  return (
    <main className="hero">
      <section className="card stack">
        ...
        <p className="muted">
          This demo proves the core flow: username/password users can bind a Lens account, and Lens-first users can create a local account automatically.
        </p>
      ...
      <section className="card stack">
        ...
        <div className="list">
          <div className="list-item">Username/password registration and login</div>
